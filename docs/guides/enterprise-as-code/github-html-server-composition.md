...
If you haven't created a project yet, head to the [previous walkthrough](https://www.fathym.com/docs/guides/enterprise-as-code/overview). If you don't have your project lookup and need to find it, you can use `fathym eac projects list`.
